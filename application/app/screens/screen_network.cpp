...
static void view_screen_network_init();
static void view_screen_network_update();
...
void screen_network_handler(stk_msg_t* msg) {
    ...
    case SCREEN_ENTRY:
        ...
        view_screen_network_init();
        view_screen_network_update();
...
void view_screen_network_init() {
    ...
    view_render_print_string(&view_render_static, 268, 150, "Back", 2, GRAY_COLOR);
...
void view_screen_network_update() {
